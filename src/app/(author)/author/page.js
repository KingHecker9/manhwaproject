      ...
      <main className="min-h-[70vh] flex items-center justify-center p-6">
        <div className="max-w-md w-full text-center bg-[var(--bg-card)] border border-[var(--border-subtle)] rounded-3xl p-8 shadow-xs space-y-4">
          ...
          <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
            Your account ({session.user.email}) does not currently have creator publishing permissions.
            Please request author access from the studio administrators to publish chapters.
          </p>
