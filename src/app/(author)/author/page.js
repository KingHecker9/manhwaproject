...
export default async function AuthorPage() {
  ...
  if (!session) {
    return (
      <main className="p-8 max-w-md mx-auto text-center">
        <h1 className="text-xl font-bold text-neutral-900 mb-2">Sign in required</h1>
        <p className="text-sm text-neutral-500 mb-6">
          You need to log in as an author to access this page.
        </p>
        <a
          href="/auth/login?returnTo=/author"
  ...
  if (!authorized) {
    return (
      <main className="p-8 max-w-md mx-auto text-center">
        <h1 className="text-xl font-bold text-neutral-900 mb-2">Author access required</h1>
